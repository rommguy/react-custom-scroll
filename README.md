...
The actual scroll is still the native one — meaning the scroll animations and scroll rate work as they always do.
The only thing that is different is the visible design and scrollbar layout.
